    ...
    const handleSave = async () => {
        ...
        const newClient = {
            ...
            phones: phones
                ...
                .map((phone) => ({ phone_number: normalizePhoneNumber(phone) })), // Используем нормализованный номер
        };
        ...
        try {
            ...
            setErrorMessage('Не удалось добавить клиента. Пожалуйста, попробуйте снова.');
        }
    };
    ...
    return (
        <div className="modal modal-open">
            <div className="modal-box">
                <h3 className="font-bold text-lg">Добавить клиента</h3>
                <div className="py-4">
                    {errorMessage && (
